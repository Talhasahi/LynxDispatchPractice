...
public class MarkedReadyActivity extends AppCompatActivity {
    ...
    private void inialization() {
        ...
        progressDialog = new ProgressDialog(MarkedReadyActivity.this);
    ...
    private void getTrips() {
        String url_ = String.format("https://lynxdispatch-api.herokuapp.com/api/trips?descending=%b&keyword=%s&status=%s", false, sharedpreferences.getString("SponserEmail", ""), "EN_ROUTE_TO_PICKUP");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (temp.getInt("totalElements") == 0) {
                        Toast.makeText(MarkedReadyActivity.this, "Trips Not Found...", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MarkedReadyActivity.this, "Trips Found...", Toast.LENGTH_SHORT).show();
                        ...
                        adp = new singlten_no_started(MarkedReadyActivity.this, tripIdList, clientNameList, pickupLocationList,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MarkedReadyActivity.this);
    ...
    private void checkInternetConnection(VolleyError error) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(MarkedReadyActivity.this);
        b.setTitle(title);
