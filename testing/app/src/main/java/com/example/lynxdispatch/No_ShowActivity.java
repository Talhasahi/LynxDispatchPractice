...
public class No_ShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_no__show);
    ...
    private void getTrips() {
        String url_ = String.format("https://lynxdispatch-api.herokuapp.com/api/trips?descending=%b&keyword=%s&status=%s", false, sharedpreferences.getString("SponserEmail", ""), "NO_SHOW_UP");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (temp.getInt("totalElements") == 0) {
                        Toast.makeText(No_ShowActivity.this, "Trips Not Found...", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(No_ShowActivity.this, "Trips Found...", Toast.LENGTH_SHORT).show();
                        ...
                        adp = new singlten_no_started(No_ShowActivity.this, tripIdList, clientNameList, pickupLocationList,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(No_ShowActivity.this);
        requestQueue.add(stringRequest);
    }

    private void inialization() {
        backButton = findViewById(R.id.backButton_no_show);
        listView = findViewById(R.id.listview_no_show);

        progressDialog = new ProgressDialog(No_ShowActivity.this);
    ...
    private void checkInternetConnection(VolleyError error) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(No_ShowActivity.this);
        b.setTitle(title);
