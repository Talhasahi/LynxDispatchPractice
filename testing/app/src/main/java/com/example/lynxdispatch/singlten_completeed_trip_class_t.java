...
public class singlten_completeed_trip_class_t extends BaseAdapter {
    ...
    singlten_completeed_trip_class_t(Context c, List<Integer> tripIdList_, List<String> clientNameList_,
