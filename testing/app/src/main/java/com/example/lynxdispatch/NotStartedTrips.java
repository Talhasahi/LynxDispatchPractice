...
public class NotStartedTrips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_not_started_trips);
        inialization();
    ...
    private void getAssignedTrips() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (temp.getInt("pageSize") == 0) {
                        Toast.makeText(NotStartedTrips.this, "Trips Not Found...", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(NotStartedTrips.this, "Trips Found...", Toast.LENGTH_SHORT).show();
                        ...
                        adp = new singlten_trip_status_class(NotStartedTrips.this, tripIdList, clientNameList, pickupLocationList,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(NotStartedTrips.this);
        requestQueue.add(stringRequest);
    }

    private void inialization() {
        backButton = findViewById(R.id.backButton_not_started);
        listView = findViewById(R.id.listview_not_started_trips);
        progressDialog = new ProgressDialog(NotStartedTrips.this);
    ...
    private void checkInternetConnection(VolleyError error) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(NotStartedTrips.this);
        b.setTitle(title);
