...
public class PrivatePayActivity extends AppCompatActivity implements singlten_calender_view.OnCalendarItemListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        remaining.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flagTripsStatus = 1;
                adp = new singlten_trip_status_class(PrivatePayActivity.this, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, flagTripsStatus);
    ...
    private void inialization() {
        ...
        remaining = findViewById(R.id.remaining_private_pay_trips);
        assigned = findViewById(R.id.assigned_private_pay_trips);
        finished = findViewById(R.id.finished_private_pay_trips);
        listView = findViewById(R.id.listview_private_pay_trips);
        calendarView = findViewById(R.id.calendarView_privatePay);
        ...
        adp1 = new singlten_calender_view(PrivatePayActivity.this, MonthList, DayList, YearList, No_Of_Trips, this);
