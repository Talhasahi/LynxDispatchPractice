...
public class ApproachingTripsActivity extends AppCompatActivity {
    ...
    private void inialization() {
        ...
        listView = findViewById(R.id.listview_approaching_trips);

        progressDialog = new ProgressDialog(ApproachingTripsActivity.this);
    ...
    private void getTrips() {
        String url_ = String.format("https://lynxdispatch-api.herokuapp.com/api/trips?descending=%b&keyword=%s&status=%s", false, sharedpreferences.getString("SponserEmail", ""), "ARRIVED_AT_PICKUP");
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (temp.getInt("totalElements") == 0) {
                        Toast.makeText(ApproachingTripsActivity.this, "Trips Not Found...", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(ApproachingTripsActivity.this, "Trips Found...", Toast.LENGTH_SHORT).show();
                        ...
                        adp = new singlten_no_started(ApproachingTripsActivity.this, tripIdList, clientNameList, pickupLocationList,
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ApproachingTripsActivity.this);
    ...
    private void checkInternetConnection(VolleyError error) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(ApproachingTripsActivity.this);
        b.setTitle(title);
