...
public class B_Legs_Activity extends AppCompatActivity {
    ...
    private void getAssignedTrips() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(B_Legs_Activity.this);
    ...
    private void inialization() {
        ...
        progressDialog = new ProgressDialog(B_Legs_Activity.this);
    ...
    private void checkInternetConnection(VolleyError error) {
        ...
        AlertDialog.Builder b = new AlertDialog.Builder(B_Legs_Activity.this);
        b.setTitle(title);
